...
# Default target host/user is: matter@matterbridge
#
# Usage:
#   bash deploy.sh
...
#
# Optional env vars:
#   REMOTE_DIR   (default: /usr/local/lib/node_modules/matterbridge-mqtt-devices)
#   REMOTE_TMP   (default: /tmp)

REMOTE_HOST="${1:-matter@matterbridge-dev}"
REMOTE_DIR="${REMOTE_DIR:-/usr/local/lib/node_modules/matterbridge-mqtt-devices}"
