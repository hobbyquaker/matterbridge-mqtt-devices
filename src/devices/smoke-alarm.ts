import { smokeCoAlarm, powerSource, MatterbridgeEndpoint } from 'matterbridge';
...
export const smokeAlarmDescriptor: DeviceDescriptor = {
  ...
  editableKeys: [
    ...
    'payloadAlarmNormal', 'payloadAlarmWarning', 'payloadAlarmCritical',
    'coStateTopic', 'coStateJsonPath',
  ],
